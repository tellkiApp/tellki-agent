(function () {
    ...
    var options = {
        ...
        exitLevel: 0,
        r: 10000,
        u: 'https://agent.tellki.com/agent',
        k: '',
        cfgFile: '',
    ...
    var sockJS = require('sockjs-client'),
        ...
        connect: function (url, callBack) {
            ...
            sock.on('connection', function () {
                ...
                api.agent.info(options, $a.uuid, function (agent) { sock.write(agent); });
            });
            ...
            sock.on('error', function (e) {
                api.log.console('Lost the connection to Tellki, retry in ' + options.r + 'ms... ' + (e !== null ? (typeof e === 'object' ? (e[0].code === undefined ? '' : e[0].code) : e) : ''), 2);
                api.jobs.stopAll($j);
                clearInterval(ping);
                callBack();
            });
    ...
    var invalid = false;
    api.log.console('args[]:' + process.argv.toString());
