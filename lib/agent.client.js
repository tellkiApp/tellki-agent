(function () {
    ...
    var api = {
        ...
        agent: {
            ...
            libraries:
            {
                install: function (installPath, setup, key, debug, callBack) {
                    ...
                    if (setup.package !== undefined) {
                        ...
                        if (setup.install !== null) {
                            var _path = path.join(installPath + setup.path, setup.opId.toString());
                ...
                try {
                    ...
                    switch (json.op) {
                        ...
                        case 100: //Install Library Response
                            api.agent.libraries.install(options.scriptPath, json, options.k, options.errorLevel === 0, function (res, duration, msg) {
